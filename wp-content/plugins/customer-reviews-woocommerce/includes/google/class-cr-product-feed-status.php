		...
		*/
		...
		protected function init_settings() {
			...
			$overview_desc .= sprintf(
				__( 'It is important to understand that having a valid structured data markup in place makes your website eligible for organic stars in Google but it doesn\'t guarantee that they will be shown. You can test the rich snippets using <a href="%1s">Google’s Rich Results Test</a>.', 'customer-reviews-woocommerce' ),
